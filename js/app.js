(() => {
    ...
    const followButton = document.querySelector(".button_black");
    if (followButton) followButton.addEventListener("click", (function(e) {
        const activeButton = document.querySelector(".button_black");
        activeButton.classList.toggle("_active");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
